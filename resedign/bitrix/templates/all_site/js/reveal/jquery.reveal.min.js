(function($){$(function(){$('a[data-reveal-id]').on('click',function(e){e.preventDefault();var modalLocation=$(this).attr('data-reveal-id');$('#'+modalLocation).reveal($(this).data());
        $('#'+modalLocation).find('.send_success').removeClass('send_success');
        $('#'+modalLocation).removeClass('status_success');    
        $('#'+modalLocation).find('#mail_success').remove();  
        $('#'+modalLocation).find('#mail_fail').remove();
